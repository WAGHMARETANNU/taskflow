    ...
    <div class="row justify-content-center">
        <div class="col-12">
            ...
            <div class="hero-section mb-4">
                <h1 class="text-center mb-2">Add New Task</h1>
            ...
            <div class="row justify-content-center">
                <div class="col-lg-8">
                    <div class="card shadow-lg">
                        ...
                        <div class="card-body">
                            <form action="{{ route('userAddTaskAction') }}" method="POST">
                                @csrf
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <div class="mb-4">
                                            <label for="priority" class="form-label">
                                                <i class="bi bi-exclamation-circle me-2"></i>Priority Level
                                            </label>
                                ...
                                <div class="row">
                                    <div class="col-12">
                                        <div class="d-grid gap-2 d-md-flex justify-content-md-center">
                                            ...
                                            <a href="{{ route('userDashboard') }}" class="btn btn-outline-secondary btn-lg">
...
<script>
    ...
    document.getElementById('task_due_date').min = new Date().toISOString().split('T')[0];
